...
option_list = list(
  ...
  make_option(c("--min_rho"), type="numeric", default=0.1, help="min rho value", metavar="character"),
  make_option(c("--max_rho"), type="numeric", default=1, help="max rho value", metavar="character"),
